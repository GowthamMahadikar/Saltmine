## My task
* Added the shoppingCart with codding
* Added the test file with codding
* To install the Test File run npm install --save-dev jest in command
* And run cmd using npm test
